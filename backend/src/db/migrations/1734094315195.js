module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('students', 'progress', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('instructors', 'userId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('analytics', 'engagement_rate', {
        transaction,
      });
